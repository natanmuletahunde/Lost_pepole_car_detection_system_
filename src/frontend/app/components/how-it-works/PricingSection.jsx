...
export default function PricingSection({ user }) {
  ...
  return (
    <Box py={20} mb={30}>
      <Paper
        bg={colorScheme === "dark" ? "#1a1b2f" : "blue.0"}
        p={40}
        radius="lg"
      >
        ...
        <SimpleGrid cols={{ base: 1, md: 2 }} spacing={30}>
          ...
          <Card
            ...
            radius="lg"
            p="xl"
            bg={colorScheme === "dark" ? "#2C2E33" : "white"}
          >
            ...
            <Button
              ...
              color="blue"
              onClick={() =>
                router.push(user ? "/user/register" : "/authentication/signup")
              }
            >
          ...
          >
            ...
            {!user && (
              <Text c="red" size="sm" mb="md">
                Please log in to access premium subscriptions.
              </Text>
            )}
            <Group grow mt="xl">
              <Button
